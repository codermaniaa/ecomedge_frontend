import {
  _slicedToArray
} from "./chunk-U535L6CR.js";
import "./chunk-PSGK2YI6.js";
import {
  KeyCode_default,
  _createSuper,
  _toConsumableArray,
...
var Indent = function Indent2(_ref) {
  ...
  for (var i = 0; i < level; i += 1) {
    var _classNames;
    list.push(React2.createElement("span", {
      key: i,
      className: (0, import_classnames.default)(baseClassName, (_classNames = {}, _defineProperty(_classNames, "".concat(baseClassName, "-start"), isStart[i]), _defineProperty(_classNames, "".concat(baseClassName, "-end"), isEnd[i]), _classNames))
    }));
  }
...
var Indent_default = React2.memo(Indent);
...
function convertTreeToData(rootNodes) {
  function dig(node) {
    ...
    return treeNodes.map(function(treeNode) {
      ...
      var _treeNode$props = treeNode.props, children = _treeNode$props.children, rest = _objectWithoutProperties(_treeNode$props, _excluded);
...
// ../../node_modules/rc-tree/es/TreeNode.js
var _excluded2 = ["eventKey", "className", "style", "dragOver", "dragOverGapTop", "dragOverGapBottom", "isLeaf", "isStart", "isEnd", "expanded", "selected", "checked", "halfChecked", "loading", "domRef", "active", "data", "onMouseMove", "selectable"];
var ICON_OPEN = "open";
...
var InternalTreeNode = function(_React$Component) {
  ...
  function InternalTreeNode2() {
    ...
    _this.renderDragHandler = function() {
      ...
      return (draggable === null || draggable === void 0 ? void 0 : draggable.icon) ? React4.createElement("span", {
    ...
    _this.renderSwitcher = function() {
      ...
      if (_this.isLeaf()) {
        ...
        return _switcherIconDom !== false ? React4.createElement("span", {
          className: (0, import_classnames2.default)("".concat(prefixCls, "-switcher"), "".concat(prefixCls, "-switcher-noop"))
        }, _switcherIconDom) : null;
      }
      var switcherCls = (0, import_classnames2.default)("".concat(prefixCls, "-switcher"), "".concat(prefixCls, "-switcher_").concat(expanded ? ICON_OPEN : ICON_CLOSE));
      var switcherIconDom = _this.renderSwitcherIconDom(false);
      return switcherIconDom !== false ? React4.createElement("span", {
    ...
    _this.renderCheckbox = function() {
      ...
      return React4.createElement("span", {
        className: (0, import_classnames2.default)("".concat(prefixCls, "-checkbox"), checked && "".concat(prefixCls, "-checkbox-checked"), !checked && halfChecked && "".concat(prefixCls, "-checkbox-indeterminate"), (disabled || disableCheckbox) && "".concat(prefixCls, "-checkbox-disabled")),
    ...
    _this.renderIcon = function() {
      ...
      var prefixCls = _this.props.context.prefixCls;
      return React4.createElement("span", {
        className: (0, import_classnames2.default)("".concat(prefixCls, "-iconEle"), "".concat(prefixCls, "-icon__").concat(_this.getNodeState() || "docu"), loading && "".concat(prefixCls, "-icon_loading"))
      });
    };
    _this.renderSelector = function() {
      ...
      if (showIcon) {
        ...
        $icon = currentIcon ? React4.createElement("span", {
          className: (0, import_classnames2.default)("".concat(prefixCls, "-iconEle"), "".concat(prefixCls, "-icon__customize"))
      ...
      var $title = React4.createElement("span", {
        className: "".concat(prefixCls, "-title")
      }, titleNode);
      return React4.createElement("span", {
        ref: _this.setSelectHandle,
        title: typeof title === "string" ? title : "",
        className: (0, import_classnames2.default)("".concat(wrapClass), "".concat(wrapClass, "-").concat(_this.getNodeState() || "normal"), !disabled && (selected || dragNodeHighlight) && "".concat(prefixCls, "-node-selected")),
    ...
    value: (
      ...
      function render() {
        ...
        return React4.createElement("div", _extends({
          ...
          onMouseMove
        }, ariaSelected, dataOrAriaAttributeProps), React4.createElement(Indent_default, {
          prefixCls,
          level,
          isStart,
          isEnd
...
var ContextTreeNode = function ContextTreeNode2(props) {
  return React4.createElement(TreeContext.Consumer, null, function(context) {
    return React4.createElement(InternalTreeNode, _extends({}, props, {
      context
    }));
  });
};
...
var Filler = React13.forwardRef(function(_ref, ref) {
  ...
  return React13.createElement("div", {
    style: outerStyle
  }, React13.createElement(es_default, {
  ...
  }, React13.createElement("div", _extends({
    style: innerStyle,
    className: (0, import_classnames3.default)(_defineProperty({}, "".concat(prefixCls, "-holder-inner"), prefixCls)),
    ref
  }, innerProps), children)));
});
...
var ScrollBar = function(_React$Component) {
  ...
  function ScrollBar2() {
    ...
    _this = _super.call.apply(_super, [this].concat(args));
    _this.moveRaf = null;
    _this.scrollbarRef = React14.createRef();
    _this.thumbRef = React14.createRef();
    ...
    value: (
      ...
      function render() {
        ...
        return React14.createElement("div", {
          ...
          className: (0, import_classnames4.default)("".concat(prefixCls, "-scrollbar"), _defineProperty({}, "".concat(prefixCls, "-scrollbar-show"), canScroll)),
          ...
          ref: this.thumbRef,
          className: (0, import_classnames4.default)("".concat(prefixCls, "-scrollbar-thumb"), _defineProperty({}, "".concat(prefixCls, "-scrollbar-thumb-moving"), dragging)),
          style: {
            width: "100%",
            height: spinHeight,
            top,
...
function Item(_ref) {
  ...
  var refFunc = React15.useCallback(function(node) {
    setRef(node);
  }, []);
...
function useChildren(list, startIndex, endIndex, setNodeRef, renderFunc, _ref) {
  ...
  return list.slice(startIndex, endIndex + 1).map(function(item, index2) {
    ...
    return React16.createElement(Item, {
      key,
...
function useHeights(getKey2, onItemAdd, onItemRemove) {
  var _React$useState = React17.useState(0), _React$useState2 = _slicedToArray(_React$useState, 2), updatedMark = _React$useState2[0], setUpdatedMark = _React$useState2[1];
...
// ../../node_modules/rc-virtual-list/es/List.js
var _excluded3 = ["prefixCls", "className", "height", "itemHeight", "fullHeight", "style", "data", "children", "itemKey", "virtual", "direction", "component", "onScroll", "onVisibleChange", "innerProps"];
var EMPTY_DATA = [];
var ScrollStyle = {
  overflowY: "auto",
  overflowAnchor: "none"
...
function RawList(props, ref) {
  var _props$prefixCls = props.prefixCls, prefixCls = _props$prefixCls === void 0 ? "rc-virtual-list" : _props$prefixCls, className = props.className, height = props.height, itemHeight = props.itemHeight, _props$fullHeight = props.fullHeight, fullHeight = _props$fullHeight === void 0 ? true : _props$fullHeight, style2 = props.style, data = props.data, children = props.children, itemKey2 = props.itemKey, virtual = props.virtual, direction = props.direction, _props$component = props.component, Component7 = _props$component === void 0 ? "div" : _props$component, onScroll = props.onScroll, onVisibleChange = props.onVisibleChange, innerProps = props.innerProps, restProps = _objectWithoutProperties(props, _excluded3);
  var useVirtual = !!(virtual !== false && height && itemHeight);
  var inVirtual = useVirtual && data && itemHeight * data.length > height;
  var _useState = (0, import_react8.useState)(0), _useState2 = _slicedToArray(_useState, 2), scrollTop = _useState2[0], setScrollTop = _useState2[1];
  var _useState3 = (0, import_react8.useState)(false), _useState4 = _slicedToArray(_useState3, 2), scrollMoving = _useState4[0], setScrollMoving = _useState4[1];
  var mergedClassName = (0, import_classnames5.default)(prefixCls, _defineProperty({}, "".concat(prefixCls, "-rtl"), direction === "rtl"), className);
  var mergedData = data || EMPTY_DATA;
  var componentRef = (0, import_react8.useRef)();
  var fillerInnerRef = (0, import_react8.useRef)();
  var scrollBarRef = (0, import_react8.useRef)();
  var getKey2 = React20.useCallback(function(item) {
  ...
  return React20.createElement("div", _extends({
  ...
  }, restProps), React20.createElement(Component7, {
    className: "".concat(prefixCls, "-holder"),
    style: componentStyle,
    ref: componentRef,
    onScroll: onFallbackScroll
  }, React20.createElement(Filler_default, {
    prefixCls,
    height: scrollHeight,
    offset,
    ...
    ref: fillerInnerRef,
    innerProps
  }, listChildren)), useVirtual && React20.createElement(ScrollBar, {
    ref: scrollBarRef,
    prefixCls,
    scrollTop,
    height,
...
var List = React20.forwardRef(RawList);
...
var useDomMotionEvents_default = function(callback) {
  ...
  var onInternalMotionEnd = React24.useCallback(function(event) {
  ...
  var CSSMotionList = function(_React$Component) {
    ...
    _createClass(CSSMotionList2, [{
      ...
      value: function render() {
        ...
        return React29.createElement(Component7, restProps, keyEntities.map(function(_ref2) {
...
function useUnmount(triggerStart, triggerEnd) {
  var _React$useState = React30.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), firstMount = _React$useState2[0], setFirstMount = _React$useState2[1];
...
var MotionTreeNode = function MotionTreeNode2(_ref, ref) {
  var className = _ref.className, style2 = _ref.style, motion = _ref.motion, motionNodes = _ref.motionNodes, motionType = _ref.motionType, onOriginMotionStart = _ref.onMotionStart, onOriginMotionEnd = _ref.onMotionEnd, active = _ref.active, treeNodeRequiredProps = _ref.treeNodeRequiredProps, props = _objectWithoutProperties(_ref, _excluded5);
  var _React$useState = React31.useState(true), _React$useState2 = _slicedToArray(_React$useState, 2), visible = _React$useState2[0], setVisible = _React$useState2[1];
  var _React$useContext = React31.useContext(TreeContext), prefixCls = _React$useContext.prefixCls;
  ...
  var triggerMotionEndRef = React31.useRef(false);
  ...
  if (motionNodes) {
    return React31.createElement(es_default3, _extends({
      ref,
      visible
    }, motion, {
      ...
      return React31.createElement("div", {
        ...
        return React31.createElement(TreeNode_default, _extends({}, restProps, treeNodeProps, {
          title,
          active,
          data: treeNode.data,
          key,
  ...
  return React31.createElement(TreeNode_default, _extends({
    domRef: ref,
    className,
    style: style2
  }, props, {
...
var RefMotionTreeNode = React31.forwardRef(MotionTreeNode);
...
var NodeList = React32.forwardRef(function(props, ref) {
  ...
  var indentMeasurerRef = React32.useRef(null);
  ...
  var _React$useState = React32.useState(expandedKeys), _React$useState2 = _slicedToArray(_React$useState, 2), prevExpandedKeys = _React$useState2[0], setPrevExpandedKeys = _React$useState2[1];
  var _React$useState3 = React32.useState(data), _React$useState4 = _slicedToArray(_React$useState3, 2), prevData = _React$useState4[0], setPrevData = _React$useState4[1];
  var _React$useState5 = React32.useState(data), _React$useState6 = _slicedToArray(_React$useState5, 2), transitionData = _React$useState6[0], setTransitionData = _React$useState6[1];
  var _React$useState7 = React32.useState([]), _React$useState8 = _slicedToArray(_React$useState7, 2), transitionRange = _React$useState8[0], setTransitionRange = _React$useState8[1];
  var _React$useState9 = React32.useState(null), _React$useState10 = _slicedToArray(_React$useState9, 2), motionType = _React$useState10[0], setMotionType = _React$useState10[1];
  var dataRef = React32.useRef(data);
  ...
  return React32.createElement(React32.Fragment, null, focused && activeItem && React32.createElement("span", {
    style: HIDDEN_STYLE,
    "aria-live": "assertive"
  }, getAccessibilityPath(activeItem)), React32.createElement("div", null, React32.createElement("input", {
    style: HIDDEN_STYLE,
  ...
  }))), React32.createElement(es_default2, _extends({}, domProps, {
    data: mergedData,
    itemKey,
    height,
    fullHeight: false,
    ...
    return React32.createElement(MotionTreeNode_default, _extends({}, restProps, treeNodeProps, {
      title,
...
var Tree = function(_React$Component) {
  ...
  function Tree2() {
    ...
    _this.listRef = React34.createRef();
  ...
  _createClass(Tree2, [{
    ...
    value: function render() {
      ...
      return React34.createElement(TreeContext.Provider, {
        value: {
          prefixCls,
          selectable,
          showIcon,
        ...
        role: "tree",
        className: (0, import_classnames8.default)(prefixCls, className, rootClassName, (_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-show-line"), showLine), _defineProperty(_classNames, "".concat(prefixCls, "-focused"), focused), _defineProperty(_classNames, "".concat(prefixCls, "-active-focused"), activeKey !== null), _classNames)),
        style: rootStyle
      }, React34.createElement(NodeList_default, _extends({
        ref: this.listRef,
        prefixCls,
        style: style2,
        data: flattenNodes,
