...
const Coupon = ({ couponInHome }) => {
  ...
  return (
    <>
      ...
      <div className="coupon-container flex flex-wrap justify-between">
         {data?.slice(0,2).map((coupon) => (
            <div
              key={coupon._id}
              className="coupon coupon-home mx-1 my-1 block md:flex lg:flex md:justify-between lg:justify-between items-center bg-gray-800 rounded-md shadow"
            >
              <div className="tengah py-3 px-3 flex items-center justify-items-start">
                <figure
                  style={{
                    width: 100,
                    height: 100,
                ...
                <div className="ml-3">
                  <div className="flex items-center font-serif">
                    <h6 className="pl-1 text-base font-medium text-white">
                    ...
                    <div className="ml-2">
                      {dayjs().isAfter(dayjs(coupon.endTime)) ? (
                        ...
                        <span className="text-gray-600 inline-block px-4 py-1 rounded-full font-medium text-xs bg-gray-100">
                          Active
                        </span>
                      )}
                    </div>
              ...
              <div className="md:border-l-2 lg:border-l-2 border-dashed lg:w-1/3 md:w-1/3 relative px-4">
                <div className="info flex items-center">
                  <div className="w-full">
                    <div className="block">
                      <div className="font-serif border border-dashed bg-gray-50 py-1 border-gray-300 rounded-lg text-center block">
                        <CopyToClipboard
                        ...
                        >
                          <button className="block w-full">
                            {copied && coupon.couponCode === copiedCode ? (
                              <span className="text-gray-600 text-sm leading-7 font-semibold">
                                Copied!
                              </span>
                            ) : (
                              <span className="uppercase font-serif font-semibold text-sm leading-7 text-gray-600">
                                {coupon.couponCode}{" "}
                              </span>
                            )}
                          </button>
                    ...
                    <p className="text-xs leading-4 text-white mt-2">
              ...
              <div className="info flex lg:my-6 md:my-5 mb-6 items-center">
                <div className="w-full">
                  <div className="block">
                    ...
                    <div className="font-serif border border-dashed bg-gray-50 py-2 border-gray-300 rounded-lg text-center block">
                      <CopyToClipboard
                        text={coupon.couponCode}
                        onCopy={() => handleCopied(coupon.couponCode)}
                      >
                        <button className="block w-full">
                          {copied && coupon.couponCode === copiedCode ? (
                            <span className="text-gray-600 text-base leading-7 font-semibold">
                              Copied!
                            </span>
                          ) : (
                            <span className="uppercase font-serif font-semibold text-base leading-7 text-gray-600">
                              {coupon.couponCode}{" "}
                            </span>
                          )}
                        </button>
