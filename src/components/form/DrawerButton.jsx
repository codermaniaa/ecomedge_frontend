...
import spinnerLoadingImage from "@/assets/img/spinner.gif";
 ...
 const DrawerButton = ({ id, title, isSubmitting,isCombinatio,handleIsCombination }) => {
      
console.log("isCombinatio,handleIsCombination....",isCombinatio,handleIsCombination);
