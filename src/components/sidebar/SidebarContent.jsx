...
const SidebarContent = () => {
  ...
  return (
    <div className="py-4 text-gray-500 dark:text-gray-400">
      <a className=" text-gray-900 dark:text-gray-200" href="/admin/dashboard">
        {/* {mode === "dark" ? (
          <img src={logoLight} alt="TriDyota" width="135" className="pl-6" />
        ) : (
          <img src={logoDark} alt="TriDyota" width="135" className="pl-6" />
        )} */}
        <img src={EcomedgeLogo} alt="TriDyota" width="135" className="pl-16" />
      </a>
      <ul className="mt-8">
        {sidebar.map((route) =>
          route.routes ? (
      ...
      <span className="lg:fixed bottom-0 px-6 py-6 w-64 mx-auto relative mt-3 block">
        <Button onClick={handleLogOut} size="large" style={{ backgroundColor: "#f34d1b" }} className="w-full">
