              ...
              <div className="max-w-7xl mx-auto">
                <div className="flex justify-between items-center md:justify-start md:space-x-10">
                  ...
                  >
                    {storeCustomizationSetting?.navbar
                      ?.categories_menu_status && (
                        <Popover className="relative font-serif">
                          <Popover.Button className="group inline-flex items-center py-2 hover:text-gray-600 focus:outline-none">
                    ...
                    <Popover className="relative font-serif">
                      <Popover.Button className="group inline-flex items-center py-2 text-sm font-medium hover:text-gray-600 focus:outline-none">
                        <span className="p-2  font-serif items-center rounded-md  w-full hover:text-gray-600">
                          <div className="w-full flex">
                            <TbBrandGooglePodcasts className="my-auto" />
                            <Link href="/catalog">
                              <a
                                // onClick={() => setIsLoading(!isLoading)}
                        ...
                        <Popover.Panel className="absolute z-10 -ml-1 mt-1 transform w-screen max-w-xs bg-white">
                          <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-y-scroll flex-grow scrollbar-hide w-full h-full">
                            <div className="relative grid gap-2 px-6 py-6">
                              {storeCustomizationSetting?.navbar
                                ?.offers_menu_status && (
                                  <span className="p-2  font-serif items-center rounded-md hover:bg-gray-50 w-full hover:text-gray-600">
                                    <div className="w-full flex">
