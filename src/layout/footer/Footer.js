...
const Footer = () => {
  ...
  const { data, error } = useAsync(() => SettingServices.getSettingFooter());
            ...
            <div className="pb-3.5 sm:pb-0 col-span-1 md:col-span-2 lg:col-span-3">
              ...
              <ul className="text-sm flex flex-col space-y-3">
                <li className="flex items-baseline">
                  ...
                  >
                    <a className="text-gray-600 inline-block w-full hover:text-gray-500">
                      <CMSkeleton
                        count={1}
                        height={10}
                        // error={error}
          ...
          {storeCustomizationSetting?.footer?.block4_status && (
            <div className="pb-3.5 sm:pb-0 col-span-1 md:col-span-2 lg:col-span-3">
              ...
              <p className="leading-7 font-sans text-sm text-gray-600 mt-3">
                ...
                />
                <br />
                <span> Tel : {data?.globalSetting?.contact}</span>
                <br />
                <span> Email : {data?.globalSetting?.email}</span>
              </p>
            </div>
          )}
        </div>
            ...
            <div className="col-span-1 text-center hidden lg:block md:block">
              {storeCustomizationSetting?.footer?.bottom_contact_status && (
                <div>
                  ...
                  <h5 className="text-2xl font-bold text-grey-500 leading-7">
                    {/* +012345-67900 */}
