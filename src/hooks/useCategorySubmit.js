...
const useCategorySubmit = ( data,id) => {
  ...
  console.log("useCategorySubmit...",data);
  ...
  const onSubmit = async ({ name, description }) => {
    try {
      ...
      const categoryData = {
        ...
        parentId: selectCategoryId && selectCategoryId !== "" ? selectCategoryId:data?.categories[0]?._id,
      ...
      (async () => {
        try {
          ...
          if (res) {
            ...
            setSelectCategoryId(res.parentId);
