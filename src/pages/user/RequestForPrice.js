...
import RequestTable from "@component/order/RequestTable";
...
const RequestForPrice = () => {
  ...
  useEffect(() => {
    OrderServices.getRequestForPrice({
      page: currentPage,
      limit: 8,
    })
      .then((res) => {
  ...
  const pageCount = Math.ceil(data?.pagination?.TotalDocuments / 8);
console.log("data?.pagination?.TotalDocuments",data);
  useEffect(() => {
    setIsLoading(false);
    if (!userInfo) {
      router.push("/");
          ...
          <div className="overflow-hidden rounded-md font-serif">
            {loading ? (
              ...
              <div className="text-center">
                <span className="flex justify-center my-30 pt-16 text-gray-500 font-semibold text-6xl">
                  <IoBagHandle />
                </span>
                    ...
                    <div className="overflow-hidden border-b last:border-b-0 border-gray-100 rounded-md">
                      <table className="table-auto min-w-full border border-gray-100 divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                          {data?.getAskForPriceDetails?.map((order) => (
                            <tr key={order._id}>
                              <RequestTable order={order} />
