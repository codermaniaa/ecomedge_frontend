...
const MyOrders = () => {
  ...
  console.log("data?.orders?.length", data);
  return (
    <>
      {isLoading ? (
                            ...
                            <tr key={order._id}>
                              ...
                              {/* <td className="px-5 py-3 whitespace-nowrap text-right text-sm">
                                <Link href={`/order/${order._id}`}>
                                  <a className="px-3 py-1 bg-gray-100 text-xs text-gray-600 hover:bg-gray-800 hover:text-white transition-all font-semibold rounded-full">
                                    Details
                                  </a>
                                </Link>
                              </td> */}
