...
const ProductScreen = ({ product, attributes, relatedProduct }) => {
  ...
  const { handleAddItem, item, setItem, handleIncreaseQuantity } =
    useAddToCart();
  ...
  const handleAddToCart = (p) => {
    if (
      p.variants.length === 1 &&
      (p.variants[0].quantity === null || p.variants[0].quantity < 1)
    )
      return notifyError("Insufficient stock");
    if (stock !== null && stock <= 0) return notifyError("Insufficient stock");
                ...
                <div className="flex flex-col xl:flex-row">
                  <div className="flex-shrink-0 xl:pr-10 lg:block w-full mx-auto md:w-6/12 lg:w-5/12 xl:w-4/12">
                    ...
                    {product?.prices?.salePrice > 1 ? (
                      <span className="relative text-dark text-sm bg-orange-500 text-white py-1 px-2 rounded font-medium z-10 right-0 top-6">
                        {discount}% off
                      </span>
                    ) : (
                      ""
                  ...
                  <div className="w-full">
                    <div className="flex flex-col md:flex-row lg:flex-row xl:flex-row">
                      <div className=" w-3/5 xl:pr-6 md:pr-6  md:w-2/3 mob-w-full">
                        ...
                        >
                          {t("User Manual   ")}
                          <FaFileArrowDown size="32px" color="1E90FF" />
                        </button>
                            ...
                            <div className=" flex justify-between gap-1">
                              <div className="mb-4">
                                {variantTitle?.map((a, i) => (
                                  <span key={i + 1}>
                                    <h4 className="text-sm py-1">{a?.name}:</h4>
                        ...
                        <div>
                          ...
                          {product?.productSpecification.productType && (
                            <dev>
                              <h3 className=" mt-10 mb-6 text-gray-600 text-base font-semibold mb-1 font-serif">
                                {t("Product Specifations")}
                              </h3>
                            </dev>
                          )}
                              ...
                              <table id="customers">
                                {product?.productSpecification?.productType && (
                                  <tr>
                                    ...
                                    <td>&nbsp;&nbsp; : &nbsp;&nbsp;</td>
                                    <td className="mt-10  text-sm font-semibold mb-1 font-serif">
                                      &nbsp;&nbsp;
                                      {
                                        product?.productSpecification
                                          ?.productType
