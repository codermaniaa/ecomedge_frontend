...
const ContactUs = () => {
  ...
  const submitHandler = async (data) => {
    ...
    AboutServices.getContact(contactDetails).then((res) => {
      if (res.success == true) {
        notifySuccess(
  ...
  //   AboutServices.getContact().then((res) => {
  //     if (res?.status === true) {
  //       // notifySuccess(res?.message);
  //       // setContact(res?.globalSetting);
          ...
          <div className="grid md:grid-cols-2 gap-6 lg:grid-cols-3 xl:gap-8 font-serif">
            {loading ? (
              ...
              <div className="border p-10 rounded-lg text-center">
                <span className="flex justify-center text-4xl text-gray-500 mb-4">
                  <FiMail />
                </span>
